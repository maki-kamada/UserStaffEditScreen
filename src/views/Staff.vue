        ...
        <table class="data">
          ...
          <tbody>
            ...
            >
              ...
              <td class="column2">{{ row.LastName }} {{ row.FirstName }}</td>
            </tr>
          </tbody>
        </table>
      </div>
          ...
          <table class="form">
            ...
            <tr>
              <div>
                ...
                <td>
                  <input class="numberInput" type="text" v-model="tel1" />
                </td>
                <td><span class="hyphen">―</span></td>
                <td>
                  <input class="numberInput" type="text" v-model="tel2" />
                </td>
                <td><span class="hyphen">―</span></td>
                <td>
                  <input class="numberInput" type="text" v-model="tel3" />
                </td>
                <td class="errMsg">
  ...
  watch: {
    id(id) {
      if (this.clearFlg == false) {
        ...
        if (this.selectedStaff == null) {
          ...
          var overlapCheck2 = this.table.find(
            (value) => value.StaffID == id && value.StaffID != exception
          );
    ...
    zipcode1(zipcode1) {
      if (this.clearFlg == false) {
        ...
        // if (
        //   this.selectedStaff == null ||
        //   String(this.selectedStaff.ZipCode).slice(0, 3) != zipcode1
        // ) {
        //   this.zipcodeSearch();
        //   return;
        // }
    ...
    zipcode2(zipcode2) {
      if (this.clearFlg == false) {
        ...
        // if (
        //   this.selectedStaff == null ||
        //   String(this.selectedStaff.ZipCode).slice(3, 7) != zipcode2
        // ) {
        //   this.zipcodeSearch();
        //   return;
        // }
